    ...
    #![allow(unused_imports)]
        ...
        impl<'a> Reader<'a> {
            ...
            pub fn which(self) -> ::std::result::Result<WhichReader<'a>, ::capnp::NotInSchema> {
              ...
              ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0))
                    ...
                    1 => {
                        return ::std::result::Result::Ok(Client(self.reader
                            .get_pointer_field(0)
        ...
        impl<'a> Builder<'a> {
            ...
            pub fn init_server(self) -> ::messages_capnp::peer::Builder<'a> {
                self.builder.set_data_field::<u16>(0, 0);
                ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0),
                                                                  0)
            }
            pub fn has_server(&self) -> bool {
            ...
            pub fn which(self) -> ::std::result::Result<WhichBuilder<'a>, ::capnp::NotInSchema> {
              ...
              ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
                    ...
                    1 => {
                        return ::std::result::Result::Ok(Client(self.builder
                            .get_pointer_field(0)
                            .get_data(::std::ptr::null(), 0)));
                    }
                    x => return ::std::result::Result::Err(::capnp::NotInSchema(x)),
        ...
        pub type WhichReader<'a> = Which<Result<::messages_capnp::peer::Reader<'a>>,
                                         Result<data::Reader<'a>>>;
        pub type WhichBuilder<'a> = Which<Result<::messages_capnp::peer::Builder<'a>>,
...
pub mod message {
  #![allow(unused_imports)]
    ...
    pub use self::Which::{AppendEntriesRequest, AppendEntriesResponse, RequestVoteResponse,
                          RequestVoteRequest};
    ...
    pub type WhichReader<'a> =
        Which<Result<::messages_capnp::append_entries_request::Reader<'a>>,
    ...
    pub type WhichBuilder<'a> =
        Which<Result<::messages_capnp::append_entries_request::Builder<'a>>,
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn which(self) -> ::std::result::Result<WhichReader<'a>, ::capnp::NotInSchema> {
            match self.reader.get_data_field::<u16>(8) {
                ...
                2 => {
                    return ::std::result::Result::Ok(InconsistentPrevEntry(self.reader
                        .get_data_field::<u64>(1)));
                }
                3 => {
                    return ::std::result::Result::Ok(InternalError(self.reader
                        .get_pointer_field(0)
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn which(self) -> ::std::result::Result<WhichBuilder<'a>, ::capnp::NotInSchema> {
            match self.builder.get_data_field::<u16>(8) {
                0 => {
                    return ::std::result::Result::Ok(Success(self.builder
                        .get_data_field::<u64>(1)));
                }
                1 => {
                    return ::std::result::Result::Ok(StaleTerm(()));
                ...
                2 => {
                    return ::std::result::Result::Ok(InconsistentPrevEntry(self.builder
                        .get_data_field::<u64>(1)));
                }
                3 => {
                    return ::std::result::Result::Ok(InternalError(self.builder
                        .get_pointer_field(0)
                        .get_text(::std::ptr::null(), 0)));
                }
                x => return ::std::result::Result::Err(::capnp::NotInSchema(x)),
...
pub mod client_request {
  #![allow(unused_imports)]
    ...
    impl<'a> Builder<'a> {
        ...
        #[inline]
        pub fn set_proposal<'b>(&mut self,
    ...
    pub type WhichReader<'a> = Which<Result<::messages_capnp::ping_request::Reader<'a>>,
                                     Result<::messages_capnp::proposal_request::Reader<'a>>,
                                     Result<::messages_capnp::query_request::Reader<'a>>>;
    pub type WhichBuilder<'a> = Which<Result<::messages_capnp::ping_request::Builder<'a>>,
...
pub mod client_response {
  #![allow(unused_imports)]
    ...
    pub type WhichReader<'a> = Which<Result<::messages_capnp::ping_response::Reader<'a>>,
                                     Result<::messages_capnp::command_response::Reader<'a>>,
                                     Result<::messages_capnp::command_response::Reader<'a>>>;
    pub type WhichBuilder<'a> = Which<Result<::messages_capnp::ping_response::Builder<'a>>,
  ...
  #![allow(unused_imports)]
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn which(self) -> ::std::result::Result<WhichReader<'a>, ::capnp::NotInSchema> {
            match self.reader.get_data_field::<u16>(0) {
                0 => {
                    return ::std::result::Result::Ok(Success(self.reader
                        .get_pointer_field(0)
                        .get_data(::std::ptr::null(), 0)));
                }
                1 => {
                ...
                2 => {
                    return ::std::result::Result::Ok(NotLeader(self.reader
                        .get_pointer_field(0)
                        .get_text(::std::ptr::null(), 0)));
                }
                x => return ::std::result::Result::Err(::capnp::NotInSchema(x)),
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn which(self) -> ::std::result::Result<WhichBuilder<'a>, ::capnp::NotInSchema> {
            match self.builder.get_data_field::<u16>(0) {
                ...
                2 => {
                    return ::std::result::Result::Ok(NotLeader(self.builder
                        .get_pointer_field(0)
                        .get_text(::std::ptr::null(), 0)));
                }
                x => return ::std::result::Result::Err(::capnp::NotInSchema(x)),
